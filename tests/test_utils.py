...
from pulse3D.constants import MAX_MINI_CARDIAC_EXPERIMENT_ID
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (MAX_MINI_CARDIAC_EXPERIMENT_ID, random_well_name(), CARDIAC_STIFFNESS_FACTOR),
        (MAX_MINI_CARDIAC_EXPERIMENT_ID + 1, random_well_name(), SKM_STIFFNESS_FACTOR),
        (MAX_MINI_SKM_EXPERIMENT_ID, random_well_name(), SKM_STIFFNESS_FACTOR),
        (MAX_MINI_SKM_EXPERIMENT_ID + 1, random_well_name(), CARDIAC_STIFFNESS_FACTOR),
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (MAX_MINI_CARDIAC_EXPERIMENT_ID, CARDIAC_STIFFNESS_LABEL),
        (MAX_MINI_CARDIAC_EXPERIMENT_ID + 1, SKM_STIFFNESS_LABEL),
        (MAX_MINI_SKM_EXPERIMENT_ID, SKM_STIFFNESS_LABEL),
        (MAX_MINI_SKM_EXPERIMENT_ID + 1, CARDIAC_STIFFNESS_LABEL),
